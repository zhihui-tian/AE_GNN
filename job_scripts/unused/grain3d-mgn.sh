...
# DAT=ls
DAT=/usr/WS2/tian9/KMC_3D_2_4_bh_slow ###(32,32,32)
# DAT=/usr/WS2/tian9/KMC_3D_2_5_bold_hot ###(64,64,64)
...
for nhid in 96; do
 ...
 --data=$DAT --dataset=longclip --frame_shape=64 --nfeat_in=1 --periodic --pointgroup=1 \
 --dim=3 --periodic \
 ...
 --n_out_predict=100 --clip_step_valid=10 --mode=train --log_mem &>>$DIR/log &
            device=$(((device+1)%4))
