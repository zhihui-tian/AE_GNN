...
PYTHON=$HOME/lassen-space/anaconda2021/envs/py37/bin/python
DAT=$HOME/data/grain

$PYTHON MeshGraphNets/main.py --data=$DAT --dir=tmp --dim=2 --periodic=1 \
  --n_mpassing=11 --nfeat_latent_node=48 --mlp_activation=mish \
  --mode=train --noise=0.02 --lr=5e-4 --RNN=0 --print_freq=1000 --valid_freq=5000 --batch=1 --rollout=tmp.pkl --n_out_pred=10 --noise=0.02
exit
